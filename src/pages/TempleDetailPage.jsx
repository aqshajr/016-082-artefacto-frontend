...
import { ArrowLeft, MapPin, BookOpen, Bookmark, BookmarkCheck } from 'lucide-react';
...
const TempleDetailPage = () => {
  ...
  const toggleBookmark = async (artifactId) => {
    try {
      ...
      console.log('Bookmark toggled for artifact:', artifactId);
    } catch (err) {
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        >
                          <Bookmark size={16} className="text-gray hover:text-primary" />
                        </button>
                      </div>
                    </div>
